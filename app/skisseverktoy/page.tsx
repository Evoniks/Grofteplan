  ...
  return (
    <main className="mx-auto min-h-screen max-w-7xl px-4 py-8 md:px-8">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 md:text-3xl">Grøfteplan-verktøy (drag/drop + måling)</h1>
          <p className="text-sm text-slate-600">Interaktiv arbeidsflate med snap points, målepiler og redigerbare etiketter.</p>
        </div>
